...
//method getChoice2() that returns the text for the first choice2 from _storyData.
...
// You can do this by right clicking on the name (storyNumber) and
// selecting Refactor -> Rename to make the change across all the places where it's used.
  ...
  void nextStory(int choiceNumber) {
    if (storyNumber == 0) {
      if (choiceNumber == 1) {
        ...
        print('novo valor storyNumber: $storyNumber');
      }
...
//Step 21 - Using the story plan, update nextStory() to change the storyNumber depending on the choice made by the user. e.g.
